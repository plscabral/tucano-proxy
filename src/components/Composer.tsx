...
export default function Composer({ onClose, initialFlow }: { onClose: () => void; initialFlow?: Flow | null }) {
  ...
  return (
    <div data-inspector="true" className="h-full flex flex-col bg-white dark:bg-[#080D1B] text-ink-500 dark:text-ink-50">
      <div className="flex items-center gap-2 px-4 h-11 border-b border-ink-100 dark:border-ink-400/30 bg-ink-50 dark:bg-[#080D1B] shrink-0">
      ...
      <div className="flex flex-1 min-h-0">
        <div className="flex-1 flex flex-col min-h-0 min-w-0">
          ...
          <div className="flex items-center gap-1 px-3 h-9 border-b border-ink-100 dark:border-ink-400/30 bg-white dark:bg-[#080D1B] shrink-0">
            ...
            <div className="flex flex-col flex-1 min-h-0 divide-y divide-ink-100 dark:divide-ink-400/20">
              <div className="flex flex-col" style={{ maxHeight: "40%" }}>
                ...
                <textarea
                  ...
                  className="flex-1 px-3 py-2 mono text-xs bg-white dark:bg-[#080D1B] resize-none outline-none focus:bg-white dark:focus:bg-ink-500 transition"
                />
              </div>
          ...
          {(response || error) && (
            <div className="border-t-2 border-toucan-400/30 flex flex-col min-h-0" style={{ height: "45%" }}>
              ...
              {response && (
                <>
                  <div className="flex items-center gap-2 px-3 h-9 border-b border-ink-100 dark:border-ink-400/30 bg-white dark:bg-[#080D1B] shrink-0">
