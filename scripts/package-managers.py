...
def formula(version, archives):
    ...
    lines.extend([
        ...
        '    (bash_completion/"tucano-proxy").write shell_output("#{bin}/tucano-proxy completions bash")',
        '    (zsh_completion/"_tucano-proxy").write shell_output("#{bin}/tucano-proxy completions zsh")',
        '    (fish_completion/"tucano-proxy.fish").write shell_output("#{bin}/tucano-proxy completions fish")',
        '  end',
        '',
        '  test do',
